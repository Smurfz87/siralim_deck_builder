...
public class TeamListAdapter : OSA<BaseParamsWithPrefab, TeamItemViewsHolder>
{
	...
	protected override TeamItemViewsHolder CreateViewsHolder(int itemIndex)
	{
		var instance = new TeamItemViewsHolder();
	...
	// *For the method's full description check the base implementation
	protected override void UpdateViewsHolder(TeamItemViewsHolder newOrRecycled)
	{
		// In this callback, "newOrRecycled.ItemIndex" is guaranteed to always reflect the
		// index of item that should be represented by this views holder. You'll use this index
		// to retrieve the model from your data set
		/*
			TeamListItemModel model = Data[newOrRecycled.ItemIndex];
	...
	// *For the method's full description check the base implementation
	/*
		protected override void OnBeforeRecycleOrDisableViewsHolder(TeamItemViewsHolder inRecycleBinOrVisible, int newItemIndex)
		{
	...
	/*
		protected override void OnItemIndexChangedDueInsertOrRemove(TeamItemViewsHolder shiftedViewsHolder, int oldIndex, bool wasInsert, int removeOrInsertIndex)
		{
	...
	public void AddItemsAt(int index, IList<TeamListItemModel> items)
	{
	...
	public void SetItems(IList<TeamListItemModel> items)
	{
	...
	IEnumerator FetchMoreItemsFromDataSourceAndUpdate(int count)
	{
		...
		var newItems = new TeamListItemModel[count];

		// Retrieve your data here
		/*
			for (int i = 0; i < count; ++i)
			{
				var model = new TeamListItemModel()
				{
					title = "Random item ",
					color = new Color(
	...
	void OnDataRetrieved(TeamListItemModel[] newItems)
	{
...
public class TeamItemViewsHolder : BaseItemViewsHolder
{
	/*
